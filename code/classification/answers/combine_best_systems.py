...
def combine_system_predictions(groups, run_id, set_name):
    ...
    for group in groups:
        ...
        for comment in comments.values():
            if comment.predicted_label/num_systems >= CLASSIFICATION_THRESHOLD:
    ...
    RunCV.write_score_predictions_to_file(comments.values(), RunCV.score_predictions_path(run_id, set_name))
